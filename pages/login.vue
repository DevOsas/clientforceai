    ...
    <div class="login-page">
      ...
      <div class="login-form-container">
        ...
        >
          ...
          <div class="form-group-custom">
            ...
            <div class="forgot-password-wrapper">
              <nuxt-link :to="{ name: 'forget-password' }" class="forgot-password-link">
                Forgot Password?
              </nuxt-link>
            </div>
          </div>
        ...
        <div class="register-link">
          ...
          <nuxt-link :to="{ name: 'signup' }" class="register-link-text">
            Register
          </nuxt-link>
        </div>
      </div>
...
.login-page {
  ...
  .login-form-container {
    ...
    &::before {
      ...
      width: 160%;
      height: 160%;
      background: radial-gradient(circle, rgba(219, 244, 221, 1) 0%, rgba(240, 253, 244, 0.3) 40%, rgba(255, 255, 255, 0) 50%);
      border-radius: 50%;
      z-index: -1;
      filter: blur(40px);
    }
