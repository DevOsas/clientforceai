  ...
  >
    <template #default="{ hide }">
      <div class="top-up-form-modal-header">
        <h3 class="top-up-form-modal-title">Email Validation Top Up</h3>
  ...
  computed: {
    dollarEquivalent() {
      const setting = this.getSetting
        ...
        : null
      return setting ? this.form.units * setting.values.emailValidation : 0
    },
  },
  methods: {
    async topUp() {
